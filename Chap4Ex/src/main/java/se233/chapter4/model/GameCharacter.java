...
public class GameCharacter extends Pane {
    ...
    public GameCharacter(int x, int y, int offsetX, int offsetY, KeyCode leftKey, KeyCode rightKey, KeyCode upKey) {
        ...
        this.gameCharacterImg = new Image(Launcher.class.getResourceAsStream("assets/MarioSheet.png")); // 4.4.3
        this.imageView = new AnimatedSprite(gameCharacterImg, 4, 4, 1, offsetX, offsetX, 16, 32); // 4.4.3
