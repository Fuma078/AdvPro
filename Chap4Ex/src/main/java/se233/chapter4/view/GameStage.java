...
public class GameStage extends Pane {
    ...
    private GameCharacter gameCharacter2; // 4.4.1
    private Keys keys;
    public GameStage() {
        keys = new Keys();
        ...
        gameCharacter2 = new GameCharacter(GameStage.WIDTH - 60, GameStage.GROUND - 40, "assets/RockmanSheet.png", KeyCode.LEFT, KeyCode.RIGHT, KeyCode.UP); // 4.4.1
