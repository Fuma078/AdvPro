...
public class GameCharacter extends Pane {
    ...
    public boolean collided(GameCharacter c) {
        ...
        if (this.isFalling && this.y < c.getY()) {
            ...
            // Respawn both characters after collision
            try {
                TimeUnit.MILLISECONDS.sleep(500); // Brief pause to show the collision
            } catch (InterruptedException e) {
                e.printStackTrace();
            }

            // Both characters respawn to their starting positions
            this.respawn();
            c.respawn();
            return true;
        }
