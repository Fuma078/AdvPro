...
public class GameStage extends Pane {
    ...
    public GameStage() {
        ...
        gameCharacterList.add(new GameCharacter(1, GameStage.WIDTH-160, 30, "assets/Character2.png", 4, 4 ,1, 129,66, KeyCode.LEFT, KeyCode.RIGHT, KeyCode.UP));
        scoreList.add(new Score(30,GROUND + 30));
        scoreList.add(new Score(GameStage.WIDTH-160,GROUND + 30));
