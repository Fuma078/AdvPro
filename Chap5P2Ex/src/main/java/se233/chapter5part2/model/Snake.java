...
public class Snake {
    ...
    public void setDirection(Direction newDirection) {
        ...
        System.out.println("Current direction: " + this.direction + ", New direction: " + newDirection);

        // Check if the new direction is opposite to current direction
        if (isOppositeDirection(this.direction, newDirection)) {
            System.out.println("Direction change blocked - opposite direction");
            // Block the direction change
            return;
        }
